Our project has three sections: a data scraper, a Davinci model finetuner, and a frontend web page.

=== Data Scraper
See the data scraper folder for an in-depth readme on how to use the program.

=== Davinci model finetuner
